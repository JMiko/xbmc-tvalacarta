...
REMOTE_VERSION_FILE = "http://www.mimediacenter.info/xbmc/goear/version.xml"
LOCAL_VERSION_FILE = xbmc.translatePath( os.path.join( ROOT_DIR , "version.xml" ) )
REMOTE_FILE = "http://xbmc-tvalacarta.googlecode.com/files/goear-"
LOCAL_FILE = xbmc.translatePath( os.path.join( ROOT_DIR , "goear-" ) )
