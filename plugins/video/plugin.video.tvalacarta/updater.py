...
def checkforupdates():
	...
	try:
		...
		if (hayqueactualizar):
			...
			dialog.ok("[updater.py] Versión "+versiondescargada+" disponible","Ya puedes descargar la nueva versión del plugin\ndesde el listado principal")

	except:
		xbmc.output("[updater.py] No se han podido verificar actualizaciones...")
