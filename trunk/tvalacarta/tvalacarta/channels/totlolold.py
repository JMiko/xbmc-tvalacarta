...
def mainlist(params,url,category):
	...
	xbmctools.addnewfolder( CHANNELNAME , "search" , CHANNELNAME , xbmc.get_localized_string( 30501 ) , "" , "", "" )

	'''
	lines = savedsearch.readsavedsearches("totlol")
	for line in lines:
		xbmctools.addnewfolder( CHANNELNAME , "videolist" , CHANNELNAME , xbmc.get_localized_string( 30501 )+' "'+line.strip()+'"' , 'http://www.totlol.com/search?search_id='+line.strip() , "", "" )
	'''
...
def videolist(params,url,category):
	...
	for match in matches:
		# Titulo
		scrapedtitle = xbmc.get_localized_string( 30701 )
		# URL
...
def play(params,url,category):
	...
	dialogWait.create( xbmc.get_localized_string( 30702 ), title , plot )
