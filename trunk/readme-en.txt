Partially automated translation...
...
tvalacarta can operate as a plugin or script, two different operating modes in XBMC.

For now I recommend operation mode "script," which is what I use, so in order to 
install the file to decompress the ZIP file in the "scripts" directory of your XBMC.

Windows full path "C:\Program Files\XBMC\scripts".

XBOX, Linux and Mac ... (coming soon).
...
This plugin has been developed with source code from XOT-UZG plugin, developed
by Basje (http://code.google.com/p/xot-uzg/). XOT-UZG has been also derived
from other projects, which are listed in his documentation or website.

All bugs you find using tvalacarta are all mine,
so i will thank you if don't contact Basje about them.