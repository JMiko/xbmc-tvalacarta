...
kideos is an XBMC plugin that let's your children
watch kideos.com videos in this great mediacenter.
...
kideos is an XBMC plugin, not an script. It has been 
...
Main channel icon has been captured from kideos page and edited using Gimp.
The other icons for downloads, settings, etc. are from Crystal Clear Collection