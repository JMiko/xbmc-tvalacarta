...
REMOTE_VERSION_FILE = "http://www.mimediacenter.info/xbmc/kideos/version.xml"
LOCAL_VERSION_FILE = xbmc.translatePath( os.path.join( ROOT_DIR , "version.xml" ) )
REMOTE_FILE = "http://xbmc-tvalacarta.googlecode.com/files/kideos-"
LOCAL_FILE = xbmc.translatePath( os.path.join( ROOT_DIR , "kideos-" ) )
