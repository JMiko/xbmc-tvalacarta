...
case $CANAL in
	...
	Paramount) rtmpdump -m 200 -r "rtmp://159.253.145.168/live" -y "185957" -W "http://www.udemy.com/static/flash/player5.9.swf" -p "http://castalba.tv/embed.php?cid=14043&wh=660&ht=410&r=www.tvline.es" -q -v > /tmp/$CANAL."$ID" & ;;
