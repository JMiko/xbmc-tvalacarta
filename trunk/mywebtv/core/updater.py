...
if thumbnail_type=="0":
    IMAGES_PATH = 'http://mywebtv.mimediacenter.info/posters/'
elif thumbnail_type=="1":
    IMAGES_PATH = 'http://mywebtv.mimediacenter.info/banners/'
elif thumbnail_type=="2":
    IMAGES_PATH = 'http://mywebtv.mimediacenter.info/squares/'
