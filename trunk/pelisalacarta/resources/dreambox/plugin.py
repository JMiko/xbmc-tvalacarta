...
def Plugins(**kwargs):
    ...
    return [
        PluginDescriptor(name = "pelisalacarta", description = "pelisalacarta 3.2.25 para Dreambox", icon="plugin-icon.png", where = PluginDescriptor.WHERE_PLUGINMENU, fnc = main),
        PluginDescriptor(name = "pelisalacarta", description = "pelisalacarta 3.2.25 para Dreambox", icon="plugin-icon.png", where = PluginDescriptor.WHERE_EXTENSIONSMENU, fnc=main)]
