...
def listarvideos(params,url,category,data):
    ...
    if not urllib.unquote_plus(titulo) in ("Últimas películas" , "Página siguiente") :
        ...
        xbmctools.addnewfolder( "trailertools" , "buscartrailer" , category ,config.get_localized_string(30110)+" "+scrapedtitle  , titulo , os.path.join(IMAGES_PATH, 'trailertools.png'), detalle ) #Buscar trailer para
#-------------------------------------------------------------------------------    
    '''   
