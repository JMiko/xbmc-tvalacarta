...
def series(item):
    ...
    if(len(matches)==1):
        for match in matches:
            itemlist.append( Item(channel=CHANNELNAME, action="series" , title="P�gina siguiente" , url=urlparse.urljoin(item.url,match), thumbnail=item.thumbnail, plot="", extra = "" , show=item.show))
...
def addChapters(item):
    #<tr> <td class="episode-title">  <a href="/capitulo/como-conoci-a-vuestra-madre/gran-dia/82013"> <strong> 6x01 </strong> - Gran d�a </a> </td> <td> 21/09/2010 </td> <td class="episode-lang">  <span class="flags spa" title="Espa�ol"></span>  <span class="flags eng" title="Ingl�s"></span>  </td> <td class="score"> 9.3 </td> </tr>
