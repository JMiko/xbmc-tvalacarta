...
def peliculas(item):
    ...
    itemlist.append( Item(channel=CHANNELNAME, title="�ltimas pel�culas"  , action="novedades", url="http://www.moviezet.com/category/movies/?cat=1,-618&orderby=date&order=desc"))
    itemlist.append( Item(channel=CHANNELNAME, title="M�s Populares"     , action="novedades",    url="http://www.moviezet.com/category/movies/?cat=1,-618&orderby=meta_value_num&order=asc&meta_key=views"))
    ...
    itemlist.append( Item(channel=CHANNELNAME, title="Por A�o"  , action="novedades", url="http://www.moviezet.com/category/movies/?cat=1,-618&orderby=meta_value&order=asc&meta_key=movie_year"))
