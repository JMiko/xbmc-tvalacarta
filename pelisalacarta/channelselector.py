...
def channels_list():
    ...
    itemlist.append( Item( title="Documentalesatonline2" , channel="documentalesatonline2", language="ES" , category="D" , type="xbmc"  ))
    itemlist.append( Item( title="Discoverymx.Wordpress" , channel="discoverymx"          , language="ES" , category="D" , type="xbmc"  ))
    ...
    if config.get_setting("enableadultmode") == "true":
        ...
        itemlist.append( Item( title="MocosoftX"         , channel="mocosoftx"            , language="ES" , category="F" , type="generic"  ))
        #itemlist.append( Item( title="Anifenix.com"      , channel="anifenix"             , language="ES" , category="F" , type="xbmc"  ))
        itemlist.append( Item( title="tuporno.tv"        , channel="tupornotv"            , language="ES" , category="F" , type="generic"  ))
        itemlist.append( Item( title="myhentaitube"      , channel="myhentaitube"         , language="ES" , category="F" , type="generic"  ))
