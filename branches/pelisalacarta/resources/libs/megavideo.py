...
def Megavideo(mega):
    logFile.debug("Megavideo")
    modoPremium = parameters.getConfigValue("megavideo.premium","false")
    logFile.debug("modoPremium="+modoPremium)
    
    if modoPremium == "false":
        logFile.debug("Usa modo normal")
        ...
        logFile.debug("Usa modo premium")
        megavideocookie = parameters.getConfigValue("megavideo.cookie","")
        logFile.debug("megavideocookie="+megavideocookie)
        if megavideocookie=="":
            logFile.debug("Averiguando cookie...")
            megavideologin = parameters.getConfigValue("megavideo.user","")
            logFile.debug("megavideologin="+megavideologin)
            megavideopassword = parameters.getConfigValue("megavideo.password","")
            logFile.debug("megavideopassword="+megavideopassword)
            megavideocookie = GetMegavideoUser(megavideologin, megavideopassword)
            logFile.debug("megavideocookie="+megavideocookie)
            parameters.setConfigValue("megavideo.cookie",megavideocookie)
        
        req = urllib2.Request("http://www.megavideo.com/xml/player_login.php?u="+megavideocookie+"&v="+mega)
    ...
    logFile.debug("movielink="+movielink)
...
def GetMegavideoUser(login, password):
    logFile.debug("GetMegavideoUser")
    # ---------------------------------------
    #  Inicializa la librería de las cookies
    # ---------------------------------------
    COOKIEFILE = configfilepath = os.path.join(os.getcwd().replace(";",""),'cookies.lwp')
    ...
    cookiedatafile = open(COOKIEFILE,'r')
...
print "-------------------------------------------------------"
#print GetMegavideoUser("tvalacarta","aeterna4u")
