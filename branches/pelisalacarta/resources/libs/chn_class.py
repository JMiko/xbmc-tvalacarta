...
#                self.onClick(self.getFocusId())
    ...
    def onUpDown(self, ignoreDisabled = False):
        ...
        try:
            ...
            if _item.type == "folder" and _item.complete == False:
                #===============================================================================
                # Locking block 
                #===============================================================================
                ...
                _item.thumb = self.CacheThumb(_item.thumbUrl)
                _item.Complete = True
...
#            data = uriHandler.Open(pageNavUrl)
    ...
    def PlayVideoItem(self, item, player=""):
        ...
        try:
            ...
            elif player=="paplayer":
                logFile.info("Playing using Paplayer")
                xbmc.Player(xbmc.PLAYER_CORE_PAPLAYER).play(playList)
            else:
