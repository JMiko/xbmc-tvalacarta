...
def mainlist(params,url,category):
	...
	xbmctools.addnewfolder( CHANNELNAME , "listsimple" , category , "Películas - Versión original"     ,"http://www.cinegratis.net/index.php?module=search&title=subtitulado","","")
	xbmctools.addnewfolder( CHANNELNAME , "listsimple" , category , "Películas - Versión latina"       ,"http://www.cinegratis.net/index.php?module=search&title=latino","","")
	...
	xbmctools.addnewfolder( CHANNELNAME , "listvideos" , category , "Series - Novedades"               ,"http://www.cinegratis.net/index.php?module=series","","")
	xbmctools.addnewfolder( CHANNELNAME , "seriesalfa" , category , "Series - Lista alfabética"        ,"","","")
	xbmctools.addnewfolder( CHANNELNAME , "listvideos" , category , "Anime - Novedades"                ,"http://www.cinegratis.net/index.php?module=anime","","")
	xbmctools.addnewfolder( CHANNELNAME , "animealfa"  , category , "Anime - Lista alfabética"         ,"","","")
	...
	xbmctools.addnewfolder( CHANNELNAME , "docualfa"   , category , "Documentales - Lista alfabética"  ,"","","")
