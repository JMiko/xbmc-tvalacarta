...
mywebtv is an XBMC plugin created in order 
to let you watch on live streaming TV.

This plugin parses and show Streaming TV listings
from popular internet sites.
...
mywebtv is an XBMC plugin, not an script. It has been tested and works on XBMC, Boxee and Plex.
